...
| [Remio](https://remio.ai/) | Local AI Knowledge Base For Agents | Capture and search files, webpages, recordings, emails, messages, images, and notes with local indexes and vectors that help agents retrieve context faster while reducing tokens and cost. | :grey_question: |
